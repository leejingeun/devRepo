...
<script type="text/javascript">
	...
	function fn_egov_select_cmmntyInfs(pageIndex){
		...
		document.listForm.action = "<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>";
		document.listForm.submit();
	}

	function fn_egov_insert_addCmmntyInf(){
		document.listForm.action = "<c:url value='/la/cop/cmy/addCmmntyInf.do'/>";
		document.listForm.submit();
	}

	function fn_egov_inqire_cmmntyInf(cmmntyId){
		document.subForm.cmmntyId.value = cmmntyId;
		document.subForm.action = "<c:url value='/la/cop/cmy/selectCmmntyInf.do'/>";
...
<form name="listForm" id="listForm" action="<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>" method="post">
	  ...
	  <th width="10%">
	   <table border="0" cellspacing="0" cellpadding="0">
	    <tr>
	      ...
	      <td>&nbsp;</td>
	      <td><span class="button"><a href="<c:url value='/la/cop/cmy/addCmmntyInf.do'/>"><spring:message code="button.create" /></a></span></td>
	      <td>&nbsp;</td>
	    </tr>
	   </table>
	  </th>
		 ...
		 <c:forEach var="result" items="${resultList}" varStatus="status">
		  <tr>
		    ...
		    <td class="lt_text3" nowrap>
		    	...
		    	<!-- 2010.11.1
	    		<form name="subForm" method="post" action="<c:url value='/la/cop/cmy/selectCmmntyInf.do'/>">
				...
				<a href="<c:url value='/la/cop/cmy/selectCmmntyInf.do'/>?cmmntyId=<c:out value='${result.cmmntyId}'/>" onclick="event(this.href); return false;" style="width:320px;border:solid 0px black;text-align:left;" >
