...
<script type="text/javascript">
	...
	function fn_egov_insert_addClbInf() {
		document.frm.action = "<c:url value='/la/cop/clb/addCmmntyClubInf.do'/>";
		document.frm.submit();
	}

	function fn_egov_select_clbInfs(pageIndex) {
		document.frm.pageIndex.value = pageIndex;
		document.frm.action = "<c:url value='/la/cop/clb/selectCmmntyClubList.do'/>";
		document.frm.submit();
	}

	function fn_egov_inqire_clbInf(clbId) {
		document.frm.clbId.value = clbId;
		document.frm.action = "<c:url value='/la/cop/clb/selectCmmntyClubInf.do'/>";
		document.frm.submit();
	}
</script>
<title>동호회 목록</title>
...
<body>
<form name="frm" method="post" action="<c:url value='/la/cop/clb/selectCmmntyClubList.do'/>">
