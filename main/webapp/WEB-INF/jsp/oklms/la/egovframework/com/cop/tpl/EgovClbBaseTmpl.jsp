...
<!--
	function fn_egov_goCmmntyHome() {
		var url = "<c:url value='/la/cop/cus/ClubMainContents.do'/>";
	...
	function fn_egov_registUser(clbId, cmmntyId) {
		window.open("<c:url value='/la/cop/clb/insertClubUserBySelf.do' />?clbId="+clbId+"&cmmntyId="+cmmntyId, "userRegist", "width=320px, height=200px;");
	}

	function fn_egov_deleteUser(clbId, cmmntyId) {
		//window.open("<c:url value='/la/cop/com/deleteClubUserBySelf.do' />?clbId="+clbId+"&cmmntyId="+cmmntyId, "userDelete", "width=320px, height=200px;");
		window.open("<c:url value='/la/cop/com/selectClubOprtrList.do' />?trgetId="+clbId+"&PopFlag=S", "userDelete", "width=640px, height=400px;");
	}
//-->
</script>
</c:otherwise>
...
<form action="<c:url value='/la/cop/cus/ClubMainContents.do' />" name="frm" method="post" >
  ...
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
		...
		<c:when test="${preview == 'true'}">
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" title="컨텐츠" src="<c:url value='/la/cop/cus/previewClubMainContents.do'/>" frameborder="0" width="758" height="480"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:when>
        <c:otherwise>
        	<!--  컨텐츠 영역 : Start -->
			<iframe id="contentFrame" title="컨텐츠" src="<c:url value='/la/cop/cus/ClubMainContents.do'/>?clbId=<c:out value='${clubVO.clbId}' />" frameborder="0" width="758" height="480"></iframe>
        	<!--  컨텐츠 영역 : End -->
        </c:otherwise>
        </c:choose>
          <br />
