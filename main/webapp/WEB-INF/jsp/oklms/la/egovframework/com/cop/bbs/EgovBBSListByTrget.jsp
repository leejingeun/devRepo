...
<script type="text/javascript">
	...
	function fn_egov_insert_addBrdMstr(){
		document.frm.action = "<c:url value='/la/cop/bbs/addBBSMasterByTrget.do'/>";
		document.frm.submit();
	}

	function fn_egov_select_brdMstr(pageNo){
		document.frm.pageIndex.value = pageNo;
		document.frm.action = "<c:url value='/la/cop/bbs/selectBdMstrListByTrget.do'/>";
		document.frm.submit();
	}
	...
	function fn_egov_inqire_brdMstr(bbsId){
		...
		document.frm.action = "<c:url value='/la/cop/bbs/SelectBBSMasterInfByTrget.do'/>";
		document.frm.submit();
	}
</script>
<title>게시판 정보</title>
