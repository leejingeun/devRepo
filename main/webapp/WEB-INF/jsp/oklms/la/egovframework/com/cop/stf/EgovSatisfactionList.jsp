...
function fn_egov_insert_satisfactionList() {
	...
	if (confirm('<spring:message code="common.regist.msg" />')) {
		document.frm.action = "<c:url value='/la/cop/stf${prefix}/insertSatisfaction.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_updt_satisfactionList() {
	...
	if (confirm('<spring:message code="common.update.msg" />')) {
		...
		document.frm.action = "<c:url value='/la/cop/stf${prefix}/updateSatisfaction.do'/>";
		document.frm.submit();
	}
}
...
function fn_egov_deleteSatisfactionList(satisfactionNo, index) {
	...
	if (confirm('<spring:message code="common.delete.msg" />')) {
		document.frm.modified.value = "true";
		document.frm.stsfdgNo.value = satisfactionNo;
		document.frm.action = "<c:url value='/la/cop/stf${prefix}/deleteSatisfaction.do'/>";
		document.frm.submit();
	}
}
