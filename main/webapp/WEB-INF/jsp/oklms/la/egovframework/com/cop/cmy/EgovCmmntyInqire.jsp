...
<script type="text/javascript">
	function fn_egov_select_cmmntyInfs() {
		document.frm.action = "<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>";
		document.frm.submit();
	}

	function fn_egov_updtCmmntyInf(cmmntyId) {
		document.frm.param_cmmntyId.value = cmmntyId;
		document.frm.action = "<c:url value='/la/cop/cmy/forUpdateCmmntyInf.do'/>";
		document.frm.submit();
	}
</script>
...
<body>
<form name="frm" method="post" action="<c:url value='/la/cop/cmy/selectCmmntyInfs.do'/>">
