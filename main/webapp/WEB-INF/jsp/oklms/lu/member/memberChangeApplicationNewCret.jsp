	...
	<table class="type-write mt-030">
		...
		<tbody>
			<tr>
				...
				<td>
					<input type="text" id="memId" name="memId" maxlength="" value="" placeholder="ex)4자이이상 입력" style="width:30%;" />
					<a href="#fn_memberIdDuckCheck" onclick="javascript:fn_memberIdDuckCheck( ); return false" class="btn-full-gray">중복확인</a>
					※"비밀번호 : 1111" 자동생성
				</td>
