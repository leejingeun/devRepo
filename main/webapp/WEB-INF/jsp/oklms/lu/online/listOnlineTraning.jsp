...
<script type="text/javascript">
		...
		<table class="type-2 mt-020" id="weekTable">
			...
			<c:forEach var="result" items="${resultList}" varStatus="status">
				<tr name="week" class="week_${result.weekCnt}">
					...
					<td><a class="btn-line-blue" href="#!" onclick="fn_content_list_pop('${result.weekCnt}');" >등록</a></td>
					<td></td>
				...
				<c:forEach var="sch" items="${scheduleList}" varStatus="sch_status">
					<c:if test="${result.weekId eq sch.weekId}">
						...
						<td class="left">
						<input name="subjTitles" id="subjTitles${sch_status.count}" type="text" value="${sch.subjTitle}">	
						...
						<td><a class="btn-search-gray" href="javascript:goPreview('${sch.linkContentYn}','${result.weekCnt}','${result.contentName}','${sch.subjStep}','${sch.subjTitle}','${sch.cmsLessonId}','${sch.contentType}','${sch.contentsDir}','${sch.contentsIdxFile}','${sch.url}');"></a></td>
						...
						<td><a onclick="moveSchUp(this);" href="#none"><img src="/images/oklms/std/inc/arrow_top.png"></a><br><a onclick="moveSchDown(this);" href="#none"><img src="/images/oklms/std/inc/arrow_down.png"></a>
						</td>
						</tr>
					</c:if>
				</c:forEach>
	...
	<div class="btn-area align-right mt-010">
		<a href="#fn_subjectList" onclick="fn_subjectList();" class="gray-1 float-left">교과목 정보</a>
