	...
	<table class="type-write">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" id="companyName" name="companyName"  maxlength="60" value="" style="width:99%;" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="text" id="choiceDay" name="choiceDay"  readonly="readonly" value="" style="width:7%;" /></td>
			</tr>
			<tr>
				<th colspan="2">업종</th>
				<td>
			...
			<tr>
				...
				<td><input type="number" min="0" max="9999" id="regularEmploymentCnt" name="regularEmploymentCnt"  maxlength="20" value="" style="width:7%;" /> 명</td>
			</tr>
			<tr>
