...
<div id="content-area">
	...
	<div class="progress-area mb-040">
		...
		<ul>
			...
			<li style="width:${ empty getProgressRate.onRealRrogressRate  ? 0 : getProgressRate.onRealRrogressRate}%; text-align: center"><span><b>${ empty getProgressRate.onRealRrogressRate  ? 0 : getProgressRate.onRealRrogressRate }</b> %</span></li>
		</ul>
	</div><!-- E : 진행율 -->
