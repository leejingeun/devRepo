...
<script type="text/javascript">
	...
	function initHtml() {
		...
		var ls_url = "http://kut80.kut.ac.kr/ozrpt/SUUP/HAK_SUUP_2020_M01R.jsp?c=한글&I_ESTBL_YY="+ls_estbl_yy+"&I_ESTBL_SEMSTR_CD="+ls_estbl_semstr_cd+"&I_COURSE_NO="+ls_course_no+"&I_PARTITN_CLAS_SE_CD="+ls_partitn_clas_se_cd;
...
<!-- http://kut80.koreatech.ac.kr/ozrpt/NCS/NC0213R.jsp?c=한글&I_ESTBL_YY="+ls_estbl_yy+"&I_ESTBL_SEMSTR_CD="+ls_estbl_semstr_cd+"&I_COURSE_NO="+ls_course_no+"&I_PARTITN_CLAS_SE_CD="+ls_partitn_clas_se_cd+"&I_STUD_ID="+ls_stud_id; -->
