	...
	<table class="type-write">
		...
		<tbody>
			<tr>
				...
				<td><input type="text" id="qustnrSj" name="qustnrSj"  value="${readQestnrInfoVO.qustnrSj}" maxlength="497" placeholder="(ex)설문제목 입력" value="" style="width:99%;" /></td>
			</tr>
			<tr>
				<th><span class="requare">*</span>시작일</th>
				<td><input type="text" id="qustnrStartDate" name="qustnrStartDate"  value="${readQestnrInfoVO.qustnrStartDate}" placeholder="(ex)2016.09.01" value="" style="width:95px" readonly="readonly" /></td>
			</tr>
			<tr>
				<th><span class="requare">*</span>종료일</th>
				<td><input type="text" id="qustnrEndDate" name="qustnrEndDate"  value="${readQestnrInfoVO.qustnrEndDate}" placeholder="(ex)2016.09.01" value="" style="width:95px" readonly="readonly" /></td>
			</tr>
			<tr>
				<th><span class="requare">*</span>설문내용</th>
				<td><input type="text" id="qustnrPurps" name="qustnrPurps" value="${readQestnrInfoVO.qustnrPurps}" maxlength="995" placeholder="(ex)설문내용 입력" value="" style="width:99%;" /></td>
			</tr>
			<tr>
				<th rowspan="6"><span class="requare">*</span>설문보기</th>
				<td>[ 보기 1 ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="qestnCn1" name="qestnCn1" value="${readQestnrItemVO.qestnCn1}" maxlength="2047" placeholder="(ex)설문보기1 입력" value="" style="width:85%;" /></td>
			</tr>
			<tr>
				<td class="border-left">[ 보기 2 ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="qestnCn2" name="qestnCn2" value="${readQestnrItemVO.qestnCn2}" maxlength="2047" placeholder="(ex)설문보기2 입력" value="" style="width:85%;" /></td>
			</tr>
			<tr>
				<td class="border-left">[ 보기 3 ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="qestnCn3" name="qestnCn3" value="${readQestnrItemVO.qestnCn3}" maxlength="2047" placeholder="(ex)설문보기3 입력" value="" style="width:85%;" /></td>
			</tr>
			<tr>
				<td class="border-left">[ 보기 4 ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="qestnCn4" name="qestnCn4" value="${readQestnrItemVO.qestnCn4}" maxlength="2047" placeholder="(ex)설문보기4 입력" value="" style="width:85%;" /></td>
			</tr>
			<tr>
				<td class="border-left">[ 보기 5 ]&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="qestnCn5" name="qestnCn5" value="${readQestnrItemVO.qestnCn5}" maxlength="2047" placeholder="(ex)설문보기5 입력" value="" style="width:85%;" /></td>
			</tr>
<!-- 			<tr>
