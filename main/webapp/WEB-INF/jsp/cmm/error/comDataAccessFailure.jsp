...
<div id="wrap-error">
	<ul>
		...
		<li class="text h-type">
			<p class="type-21">데이터 처리 중 오류가 발생하였습니다.[DataAccessExp]</p>
			<p class="type-22">잠시후 <br />다시 접속 해 주시기 바랍니다</p>
			<p class="type-23"><a href="#LINK"
								  onClick="fncGoAfterErrorPage();">바로가기</a></p>
		</li>
