...
<script type="text/javascript">
	...
	function fn_egov_deleteFile(atchFileId, fileSn) {
		if (confirm("삭제 하시겠습니까?")) {
			...
			form.action = "<c:url value='/cmm/fms/deletePlanFileInfs.do'/>";
			form.submit();
		}
	}
...
<!--<title>파일목록</title> -->
	...
	<table>
		...
		<tr>
			<td style="border:0px solid #eb5c01;">
			<c:choose>
				...
				<c:otherwise>
					...
					<img src="/images/oklms/std/board/file_btn_01.png" align="bottom" alt="첨부파일." /><c:out value="${fileVO.orignlFileNm}"/>&nbsp;[<c:out value="${fileVO.fileMg}"/>&nbsp;byte]
					</a>
					<img style="cursor:pointer;" src="<c:url value='/images/egovframework/com/cmm/fms/icon/bu5_close.gif' />"
						width="19" height="18" onClick="fn_egov_deleteFile('<c:out value="${fileVO.atchFileId}"/>','<c:out value="${fileVO.fileSn}"/>');" alt="파일삭제">
				</c:otherwise>
