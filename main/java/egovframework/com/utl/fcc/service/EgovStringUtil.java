...
public class EgovStringUtil {
	...
	/**
	 * <p>지정한 길이만큼 앞으로 0을 붙여 리턴.</p>
	 *
	 * <pre>
	 *   StringUtil.fillZeroStr(1,3) = "001"
	 * </pre>
	 *
	 * @param val 원본값, length 전체길이값
	 * @return " 0 "이 추가된 문자열
	 */
	public static String fillZeroStr(int val, int length) {
		return fillZeroStr(String.valueOf(val), length);
	}
	 ...
	 * @return " 0 "이 추가된 문자열
	 */
	public static String fillZeroStr(String val, int length) {
