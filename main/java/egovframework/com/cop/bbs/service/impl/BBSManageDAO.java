...
public class BBSManageDAO extends EgovComAbstractDAO {
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectMainPageBoardArticleList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectMainPageBoardArticleList", boardVO);
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public List<BoardVO> selectTopNoticeYnBoardArticleList(BoardVO boardVO) throws Exception {
	return (List<BoardVO>) list("BBSManageDAO.selectTopNoticeYnBoardArticleList", boardVO);
    }
     ...
     * @throws Exception
     */
    public int selectTopNoticeYnBoardArticleListCnt(BoardVO boardVO) throws Exception {
	return (Integer)select("BBSManageDAO.selectTopNoticeYnBoardArticleListCnt", boardVO);
    }
