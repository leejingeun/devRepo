package kr.co.sitglobal.oklms.la.egovframework.com.uss.ion.pwm.web;
...
//	/**
//	 * 팝업창을 오픈 한다. : kr.co.sitglobal.oklms.commbiz.popup.web.CommbizPopupController.egovPopupManagePopupOpen 에서 처리하도록 변경 (/commbiz/uss/ion/pwm/openPopupManage.do )
//	 * @param commandMap
//	 * @param popupManageVO
//	 * @return
//	 * @throws Exception
...
//	}
	...
	/**
	 * 팝업창관리 메인 테스트 목록을 조회한다.  : kr.co.sitglobal.oklms.commbiz.popup.web.CommbizPopupController.egovPopupManagePopupOpen 에서 처리하도록 변경 (/commbiz/uss/ion/pwm/openPopupManage.do )
	 * @param popupManageVO
	 * @param model
